...
- **Model Prober** — Minimal chat probes across all registered providers (configurable) to hide models that have not passed; runs on startup/redeploy, then every `12h` by default
