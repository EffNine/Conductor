...
// TestEndToEndCacheProviderIsolation is the end-to-end regression for the
...
func TestEndToEndCacheProviderIsolation(t *testing.T) {
...
// TestEndToEndProviderFallbackTelemetry is the end-to-end regression for
...
func TestEndToEndProviderFallbackTelemetry(t *testing.T) {
	reg := provider.NewRegistry()
	openai := &routingChatStubProvider{
		name:   "openai",
		models: []provider.ModelInfo{{ProviderModelID: "gpt-4o", ModelID: "gpt-4o", OwnedBy: "openai"}},
