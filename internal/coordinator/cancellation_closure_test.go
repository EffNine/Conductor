...
func TestCoordinatorCancellationClosure_CoordinatorCancellationFinalizesParent(t *testing.T) {
	db := newTestDB(t)
	s := newStore(t, db)
...
func TestCoordinatorCancellationClosure_CoordinatorCancellationCancelsChildren(t *testing.T) {
	db := newTestDB(t)
	s := newStore(t, db)
	coordS := newCoordStore(t, db)
...
func TestCoordinatorCancellationClosure_CoordinatorCancellationNotRetryable(t *testing.T) {
	db := newTestDB(t)
	s := newStore(t, db)
	coordS := newCoordStore(t, db)
	cfg := coordinator.NewConfig()
...
func TestCoordinatorCancellationClosure_CancellationEventExactlyOnce(t *testing.T) {
	db := newTestDB(t)
	s := newStore(t, db)
...
func TestCoordinatorCancellationClosure_CancellationNoContradictoryTerminalEvent(t *testing.T) {
	db := newTestDB(t)
	s := newStore(t, db)
...
func TestCoordinatorCancellationClosure_ConcurrentDelegateSingleChildSet(t *testing.T) {
	db := newTestDB(t)
	s := newStore(t, db)
	coordS := newCoordStore(t, db)
	coord := coordinator.New(coordS, nil, newLogger(t), coordinator.NewConfig())
...
func TestCoordinatorCancellationClosure_ConcurrentDelegateReturnsSameChildren(t *testing.T) {
	db := newTestDB(t)
	s := newStore(t, db)
	coordS := newCoordStore(t, db)
	coord := coordinator.New(coordS, nil, newLogger(t), coordinator.NewConfig())
...
func TestCoordinatorCancellationClosure_ResumeDoesNotDuplicateAfterConcurrentDelegate(t *testing.T) {
	db := newTestDB(t)
	s := newStore(t, db)
	coordS := newCoordStore(t, db)
	coord := coordinator.New(coordS, nil, newLogger(t), coordinator.NewConfig())
...
func TestCoordinatorCancellationClosure_IllegalTransitionProtection(t *testing.T) {
	db := newTestDB(t)
	s := newStore(t, db)
...
func TestCoordinatorCancellationClosure_LeaseOwnershipStillProtected(t *testing.T) {
	db := newTestDB(t)
	s := newStore(t, db)
...
func TestCoordinatorCancellationClosure_RetryableFailureNotTerminal(t *testing.T) {
	db := newTestDB(t)
	s := newStore(t, db)
...
func TestCoordinatorCancellationClosure_PermanentFailureTerminal(t *testing.T) {
	db := newTestDB(t)
	s := newStore(t, db)
...
func TestCoordinatorCancellationClosure_SingleAgentStillWorks(t *testing.T) {
	db := newTestDB(t)
	s := newStore(t, db)

	taskID := "gateway-single"
...
func TestCoordinatorCancellationClosure_GatewayUnchanged(t *testing.T) {
	db := newTestDB(t)
	s := newStore(t, db)
