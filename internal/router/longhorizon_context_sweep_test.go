...
func TestLongHorizonContextSweep(t *testing.T) {
...
// TestLongHorizonUnknownContextNotPreferred locks the semantics of
...
func TestLongHorizonUnknownContextNotPreferred(t *testing.T) {
	pipeline, store, _ := setupCalibPipeline(t,
...
// TestLongHorizonToolOverheadFlipsEligibility verifies tool definitions
...
func TestLongHorizonToolOverheadFlipsEligibility(t *testing.T) {
	pipeline, store, _ := setupCalibPipeline(t,
		&calibStubProvider{name: "aaa", supportsAll: true, reasoning: true, toolCalling: true, latencyMs: 100, healthState: runtime.StateHealthy, costPerUnit: 0.0002, maxContext: 32768},
...
// TestLongHorizonExplicitRouteNoExpansion verifies that with an explicit
...
func TestLongHorizonExplicitRouteNoExpansion(t *testing.T) {
	pipeline, store, _ := setupCalibPipeline(t,
		&calibStubProvider{name: "aaa", supportsAll: true, reasoning: true, toolCalling: true, latencyMs: 100, healthState: runtime.StateHealthy, costPerUnit: 0.0002, maxContext: 32768},
		&calibStubProvider{name: "zzz", supportsAll: true, reasoning: true, toolCalling: true, latencyMs: 100, healthState: runtime.StateHealthy, costPerUnit: 0.0002, maxContext: 128000},
	)
