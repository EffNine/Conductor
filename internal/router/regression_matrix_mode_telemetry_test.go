...
func TestRegressionMatrixModeTelemetry(t *testing.T) {
...
// TestRegressionMatrixTelemetryIrrelevantOutsidePlanningAgentic locks the
...
func TestRegressionMatrixTelemetryIrrelevantOutsidePlanningAgentic(t *testing.T) {
